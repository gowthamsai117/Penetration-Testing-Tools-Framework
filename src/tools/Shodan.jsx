...
function Shodan() {
    ...
    const handleScan = async () => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/shodan`, { ip: target });
    ...
    return (
        <div ref={containerRef} className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6">
            ...
            <div className="gsap-header flex items-center gap-4 opacity-0">
                ...
                <div>
                    <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">Shodan</h2>
                    <p className="text-cyber-primary font-mono text-xs tracking-[0.2em] uppercase mt-1">Search Engine for Internet-Connected Devices</p>
                </div>
            </div>
            ...
            <div className="gsap-guide glass-panel p-4 border border-white/5 bg-white/5 rounded-lg opacity-0">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                    Enter an IP address (e.g., <code className="text-cyber-primary bg-black/30 px-1 rounded">8.8.8.8</code>) to retrieve information about open ports, vulnerabilities, and server details using the Shodan API.
                </p>
            </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 relative z-10">
                    <div className="relative flex-1 group">
                        ...
                        <input
                            ...
                            className="w-full bg-black/50 border border-white/10 rounded-lg py-3 pl-10 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-cyber-primary/50 focus:ring-1 focus:ring-cyber-primary/50 transition-all font-mono"
                        />
                    </div>
                    <button
                        onClick={handleScan}
